    ...
    IERC721Enumerable
{
    ...
    function tokenOfOwnerByIndex(address _owner, uint256 index)
        ...
        returns (uint256)
    {
        require(index < balanceOf(_owner), "ERC721A: owner index out of bounds");
    ...
    function approve(address to, uint256 tokenId) external override {
        ...
        require(to != _owner, "ERC721A: approval to current owner");
    ...
    function _safeMint(
        ...
        _addressData[to] = AddressData(
            ...
            msg.sender == owner() ? addressData.numberMinted : addressData.numberMinted + uint128(quantity)
        );
